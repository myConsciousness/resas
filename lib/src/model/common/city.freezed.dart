...
abstract class $CityCopyWith<$Res> {
  ...
  $Res call(
      {@JsonKey(name: 'cityCode') String code,
      @JsonKey(name: 'cityName') String name,
      @JsonKey(name: 'bigCityFlag') CityType type});
}
...
class _$_City implements _City {
  const _$_City(
      {@JsonKey(name: 'cityCode') required this.code,
      @JsonKey(name: 'cityName') required this.name,
      @JsonKey(name: 'bigCityFlag') required this.type});
...
abstract class _City implements City {
  const factory _City(
      {@JsonKey(name: 'cityCode') required String code,
      @JsonKey(name: 'cityName') required String name,
      @JsonKey(name: 'bigCityFlag') required CityType type}) = _$_City;
